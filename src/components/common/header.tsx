        ...
        <header className="w-full border-b border-b-gray-200 bg-white shadow">
            <div className="container mx-auto px-4 py-2 flex items-center justify-between gap-4">
                ...
                <nav className="hidden lg:flex items-center space-x-4 text-sm text-gray-700">
                    {navItems.map((item, i) => (
                        <div key={i} className="flex items-center cursor-pointer hover:text-blue-600">
                            {item.label}
                ...
                <div className="flex items-center gap-2 text-sm">
                    <button className="border px-2 py-1 rounded text-gray-700">বাং</button>
                    <div className="hidden lg:flex items-center gap-1 text-green-600 font-medium">
                        <FiPhoneCall className="w-5 h-5" />
                        16910
                    </div>
                    <button className="bg-green-600 text-white px-4 py-2 rounded text-sm">লগ-ইন</button>
                </div>
                ...
                <div className="lg:hidden px-4 pb-4">
                    <div className="flex flex-col gap-2 text-sm text-gray-700 mt-2">
                        ...
                        <div className="flex items-center gap-2 mt-2">
                            ...
                            <button className="bg-green-600 text-white px-4 py-2 rounded text-sm ml-auto">লগ-ইন</button>
                        </div>
                    </div>
                </div>
            )}
